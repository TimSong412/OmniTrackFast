...
from .raft_online import RAFTDepthDataset, RAFTExhaustiveDataset, SimpleDepthDataset, RAFTsimpleDataset
from .longterm import LongtermDataset, CotrackerDataset, CoTrackerSingle, CoTrackerDense
...
dataset_dict = {
    ...
    'flow_simple': RAFTsimpleDataset,
    'gmflow': GMExhaustiveDataset,
    'depth': RAFTDepthDataset,
    'long': LongtermDataset,
    'simple': SimpleDepthDataset,
    'cotracker': CotrackerDataset,
    'gm': GMDepthDataset,
    'rgb': RGBDepthDataset,
    'cotrackersingle': CoTrackerSingle,
    'cotrackerdense': CoTrackerDense,
    'offline': OfflineDepthDataset,
    'rand': SimpleRandomDataset
}
...
class StackDataset(Dataset[T_co]):
    ...
    def __init__(self, datasets: Iterable[Dataset], datasettypes:list) -> None:
    ...
    def __getitem__(self, idx):
        return {datasettype: dataset[idx] for dataset, datasettype in zip(self.datasets, self.datasettypes)}
